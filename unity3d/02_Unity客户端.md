...
title: Unity客户端
category: unity3d
created_at: 2026-08-25 05:50:14
view_count: 9
---
...
| 文档 | 说明 |
|------|------|
| [ui](http://wangranhit.pythonanywhere.com/blog/show/87) | UI 框架：生命周期状态机、数据驱动更新、工厂模式、各业务界面 |
| [network](http://wangranhit.pythonanywhere.com/blog/show/89) | 网络通信：TCP 连接管理、数据包格式、协议收发、双服务器架构 |
| [event_dispatcher](http://wangranhit.pythonanywhere.com/blog/show/92) | 事件系统：客户端内部事件分发 + 网络协议消息分发的双分发器设计 |
| [game_logic](http://wangranhit.pythonanywhere.com/blog/show/93) | 核心游戏逻辑：主控制器、账号管理、玩家移动、世界同步、相机跟随 |
| [loader](http://wangranhit.pythonanywhere.com/blog/show/94) | 资源加载：AssetBundle 异步加载队列、依赖管理、LRU 缓存、场景加载状态机 |
| [system](http://wangranhit.pythonanywhere.com/blog/show/90) | 组件式系统：移动组件（NavMesh 寻路）、角色状态更新组件 |
| [resource](http://wangranhit.pythonanywhere.com/blog/show/91) | 配置表系统：CSV 解析、泛型管理器、世界/地图配置 |